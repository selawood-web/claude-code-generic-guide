...
#
# Copies the behavior rules, the 20 skills, the lifecycle hooks, the validator,
...
if [ -e "$TARGET/.claude/skills" ]; then
  ...
  note_copied ".claude/skills/ (20 skills)"
fi
...
echo "     'what skills are available?' — expect twenty."
