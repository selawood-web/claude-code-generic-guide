...
- 23 production-ready skill workflows (commit, PR, code review, architecture, code generation, decision-making, deployment, memory capture, etc.)
...
```
Copies everything below in one step — rules, bridge, all 23 skills, hooks,
...
```
This installs all 23 skill workflows, their critic and strategy references, and the hook wiring (`settings.json`).
...
│   ├── skills/                  ← 23 reusable skill workflows
