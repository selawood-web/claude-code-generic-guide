...
- 20 production-ready skill workflows (commit, PR, code review, architecture, code generation, decision-making, memory capture, etc.)
...
```
Copies everything below in one step — rules, bridge, all 20 skills, hooks,
...
```
This installs all 20 skill workflows, their critic and strategy references, and the hook wiring (`settings.json`).
...
│   ├── skills/                  ← 20 reusable skill workflows
