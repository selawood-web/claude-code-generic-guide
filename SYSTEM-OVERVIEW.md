...
```mermaid
flowchart LR
    A["Session starts<br/><i>rules + memory load</i>"] --> B["Work<br/><i>24 skills, quality gate</i>"]
...
| **The 24 skills** | Written procedures for repeatable work — each checked for fit before it is trusted |
